...
public class Game:GameWindow
    {
        ...
        public Game(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings)
            ...
            casa = new Casa(); // inicializar con valores no nulos
        ...
        protected override void OnLoad()
        {
           ...
           _shader = new Shader("Common/Shaders/vertexShader.vert", "Common/Shaders/fragmentShader.frag");            _shader.Use();
           _shader.Use();
        ...
        protected override void OnUnload()
        {
            ...
            GL.DeleteProgram(_shader._handle);
