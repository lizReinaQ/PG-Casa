...
namespace CasaTarea
{
    public class Casa
    {
        ...
        {
            float[] _vertices = {
            x+((anchura/2)*0.2f), y-((0.65f*altura)/2), z-(profundidad/2), 1.0f, 1.0f, 0.0f,
            x+((anchura/2)*0.2f), y-(((0.65f*altura)/2)*0.3f), z-(profundidad/2), 1.0f, 1.0f, 0.0f,
            x-((anchura/2)*0.2f), y-((0.65f*altura)/2), z-(profundidad/2), 1.0f, 1.0f, 0.0f,

            x-((anchura/2)*0.2f), y-(((0.65f*altura)/2)*0.3f), z-(profundidad/2), 1.0f, 0.0f, 0.0f,
            x-((anchura/2)*0.2f), y-((0.65f*altura)/2), z-(profundidad/2), 1.0f, 0.0f, 0.0f,
            x+((anchura/2)*0.2f), y-(((0.65f*altura)/2)*0.3f), z-(profundidad/2), 1.0f, 0.0f, 0.0f, 
        };
